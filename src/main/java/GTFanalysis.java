...
////			record.setGene_id(gene.getGeneId());
////			record.setGene_symbol(gene.getGeneSymbol());
...
////						}
////						else {
////							int stat = Annote.getType_stat(the_script.getTransType(), script.getTransType(), 1);
////							if (stat < 0) {
////								script = the_script;
////							}
////							else if (stat == 0
...
////			}
////			if (script != null) {
////				record.setScript_id(script.getTransId());
////				record.setScript_type(script.getTransType());
////				record.setGene_type(Annote.getScript_type(script.getTransType()));
////			}
////			out_list.add(record);
////		}
////		if (!gene_flag) {
...
////			if (node != null) {
////				record.setGene_id(node.getValue().getGeneId());
////				record.setGene_symbol(node.getValue().getGeneSymbol());
////			}
////			else {
...
////			if (node != null) {
////				record.setGene_type(node.getValue().getGeneId());
////				record.setScript_type(node.getValue().getGeneSymbol());
////			}
////			else {
