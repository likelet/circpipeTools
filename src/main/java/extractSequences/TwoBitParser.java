...
//		String filepath = "F:\\PHDProject\\M6AData\\mm10.2bit";
//		TwoBitParser p = new TwoBitParser(new File(filepath));
//		String[] seqName = p.getSequenceNames();
//		ArrayList<String>seqList = new ArrayList<String>(Arrays.asList(seqName));
//		if(!seqList.contains("4_GL456216_random")){
//			System.out.println(1);
//		}
//		if(seqList.contains("1")){
