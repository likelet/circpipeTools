...
public class GTFterm {
    ...
    public GTFterm(String str){
        ...
        this.seqname = tempstr[0];
        this.source = tempstr[1];
        this.feature = tempstr[2];
        this.start = Integer.parseInt(tempstr[3]);
        this.end =  Integer.parseInt(tempstr[4]);
        this.score = tempstr[5];
    ...
    public GTFterm(String seqname, String source, String feature, int start, int end, String score, String strand, String frame, String attrbute) {
    ...
    public void format(String attrbute) {
        ...
        for (int i = 0; i < arr.length; i++) {
            String[] tempa = arr[i].trim().split(ToolsforCMD.GTF_SPILT);
